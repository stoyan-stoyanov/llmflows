...
class TestMessageHistory(unittest.TestCase):
    ...
    def test_system_prompt(self):
        ...
        self.assertEqual(self.message_history.messages[0]["content"], "New system prompt")
    ...
    def test_add_message(self):
        ...
        self.assertEqual(self.message_history.messages[-1]["content"], "Test user message")
    ...
    def test_replace_message(self):
        ...
        self.message_history.replace_message(
            new_role="user", 
            new_message="Replacement message",
            idx=-2
            )
        self.assertEqual(self.message_history.messages[1]["content"], "Replacement message")
